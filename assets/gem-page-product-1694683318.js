...
if($('.gempage-editing').length < 1){
 ...
 function addDate(plus){
    ...
    if(todayP2.getUTCDay() == 0){
      todayP2.setUTCDate(todayP2.getUTCDate() + 6);
  ...
  var $module = jQuery('#m-1694660832586').children('.module');
...
if($('.gempage-editing').length < 1){
 ...
 function addDate(plus){
  ...
  var $module = jQuery('#m-1694660855826').children('.module');
...
$(".form-desktop").click(function(e){
  ...
  (function(jQuery) {
  var $module = jQuery('#m-1695735672427').children('.module');
  var swatchText = $module.attr('data-swatch-text') != undefined ? $module.attr('data-swatch-text') : '1';
  $module.gfV3ProductSwatches({
    swatchText: swatchText,
    onSwatchSelected: function(variant, $swatch) {}
  ...
  // You can add custom Javascript code right here.
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1695736748433').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1695736748433";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1695736748433") {
      window.getPopup1695736748433 = function() {
